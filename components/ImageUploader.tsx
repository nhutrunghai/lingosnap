...
const ImageUploader: React.FC<ImageUploaderProps> = ({ onImageSelect }) => {
  ...
  return (
    <button
      type="button"
      className="group relative w-full overflow-hidden rounded-xl border border-white/70 bg-white p-5 text-left shadow-xl shadow-slate-200/70 transition hover:-translate-y-1 hover:shadow-2xl sm:p-5 lg:p-5"
    ...
    >
      ...
      <div className="relative grid gap-4 md:grid-cols-[auto_1fr_auto] md:items-center">
        ...
        <div className="inline-flex items-center gap-2 rounded-xl bg-blue-600 px-4 py-2.5 text-sm font-black text-white shadow-lg shadow-blue-200">
